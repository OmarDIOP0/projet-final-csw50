...
class QuizSerializer(serializers.ModelSerializer):
    class Meta:
        model = Quiz
        fields = ['id', 'lesson', 'question', 'answer1','answer2','answer3','answer4', 'correct_answer']

class LessonSerializer(serializers.ModelSerializer):
    quizzes = QuizSerializer(many=True,read_only=True,source='quiz_set')
    class Meta:
        model = Lesson
        fields = ['id', 'course', 'creator', 'title', 'description', 'video_url', 'file', 'created_at', 'updated_at','is_completed','quizzes']
